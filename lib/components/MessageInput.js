  ...
  render() {
    ...
    return(
      <form className="MessageInput">
        ...
        <button className="SubmitButton" type="submit" onClick={(e) => this.createMessage(e)} disabled={buttonToggle} value="SubmitMessage">Submit</button>
...
//isn't it redundant to be using 3 methods to submit a message?
