...
export default class Application extends Component {
  ...
  componentDidMount(){
    //set this.state.user here
    // var x = firebase.database().ref('messages');
    // x.on('value', function () {
    //   console.log("hi");
    // });
  ...
  loadMessages(){
    ...
    reference.on('value', function (snapshot) {
      var messages = that.returnArray(snapshot.val());
      //still need to set state of messages here
