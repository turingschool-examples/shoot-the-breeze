    ...
    return (
      <div className="application">
        ...
        <div className="footer">
          {user ? <p className="user-welcome-bar">Logged in as <span className="user-name">{user.displayName.split(' ')[0]}</span> ({user.email})</p> : <button onClick={() => signIn()}>Sign In</button> }
