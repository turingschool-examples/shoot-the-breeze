...
export default class Application extends Component {
  ...
  onAuthStateChanged(user){
    ...
    if (user) {
      ...
      loggedInAs.removeAttribute('hidden');
      loggedInAs.textContent = "Logged in as " + labels.userName + " (" + labels.email + ")" + ".";
    } //end of if user is signed in
    else {
      let footerBottomComponent = document.querySelector('.footer-bottom-component');
      footerBottomComponent.setAttribute('hidden', 'true');
      loggedInAs.setAttribute('hidden', 'true');
