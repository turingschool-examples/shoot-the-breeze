    ...
    return (
      <div onLoad={this.initFirebase()}>
        <header>
          ...
          <input id="filter-input-field" type="text" placeholder="Filter" onChange={this.updateSearch.bind(this)} value={this.state.searchFilter}></input>
...
class ChatMaster extends React.Component {
  ...
  render () {
    ...
    const searchedMessage = this.props.messages.filter(
        (message) => {
