...
export default class Application extends Component {
  ...
  onAuthStateChanged(user){
    if (user) {
      ...
      let userPicField = document.querySelector('.user-pic');
  ...
  render(){
    return (
      <div onLoad={this.initFirebase()}>
        ...
        <input id="message-entry-field" type="text" placeholder="Message" onChange={this.handleInputChange.bind(this)} value={this.state.newMessage} onKeyDown={this.detectFieldContent.bind(this)} onBlur={this.detectFieldContent.bind(this)}></input>
        ...
        <ClearInput isDisabled={this.state.clearButtonDisabled}/>
