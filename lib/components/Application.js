...
export default class Application extends Component {
  ...
  onAuthStateChanged(user){
    ...
    if (user) {
      //user is logged in
      this.showLoggedInUser(items.loggedInAs, items.userName, items.email); //this is fine; it happens the same each time
      this.showClearMessageButton();
      this.showLogOutButton();
      this.showItem(items.messageEntryField, items.submitMessageButton);
  ...
  // showItem(messageEntryField, submitMessageButton, logInButton){
